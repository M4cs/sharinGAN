...
Original file is located at
    https://colab.research.google.com/drive/1VgzvqseR7Q3q2NCFq1t8ZvLOVCemiIoa
"""
...
for epoch in range(epochs):
    for i, (images, labels) in enumerate(dataset):
        ...
        g_loss = loss(discriminator(gen), val)
        ...
        real_loss = loss(discriminator(real_images), val)
        #calculate the fake loss from the generated image
        fake_loss = loss(discriminator(gen.detach()),fake)
